...
def create_app():
    ...
    def admin_register():
        if request.method == 'POST':
            ...
            if Admin.query.filter_by(username=username).first():
                flash('Ursername already taken.', 'error')
                return render_template("admin_register.html")
            ...
            db.session.commit()
            flash('Admin register successfrlly.', 'success')
            return redirect(url_for('admin_login'))
    ...
    def admin_login():
        if request.method == 'POST':
            ...
            flash("lOgged in sussessfully.","success")
